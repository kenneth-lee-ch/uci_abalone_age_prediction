...
When performing model validation, MSPE, Mallow’s Cp, and the adjusted R-squared are used as criterion for consistency. The results are summarized in ​`Table 3​` . 
